    ...
    if (this.props.getToken()) {
      return (
        <List>
          ...
          <ListItem>
            <Button href={process.env.PUBLIC_URL + "/SideEvents"}>
              SideEvents
            </Button>
          </ListItem>
          <ListItem>
            <Button href={process.env.PUBLIC_URL + "/About"}>About</Button>
          </ListItem>
          <ListItem>
            <Button href={process.env.PUBLIC_URL + "/Contact"}>Contact</Button>
          </ListItem>
          <ListItem>
            <Button href={process.env.PUBLIC_URL + "/Exhibitor"}>
              Exhibitors
            </Button>
          </ListItem>
          <ListItem>
            <Button href={process.env.PUBLIC_URL + "/Hackhaton"}>
              Hackhaton
            </Button>
          </ListItem>
          <ListItem>
            <Button href={process.env.PUBLIC_URL + "/TestimonialAndGallery"}>
